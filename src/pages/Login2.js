			...
			<div className="login_body">
				<div className="login_body_services">
					<div className="services_left">
						<h1 className="main_headings">
							Connecting Who Knows <br /> And Knowing
						</h1>
						...
						<div className="services_buttons">
							<GoogleLogin
								...
								render={(renderProps) => (
									<p onClick={renderProps.onClick} className="solve_button">
										Solve Queries
									</p>
								)}
				...
				<div className="login_body_whyWe">
					<h1 className="main_headings">Why Clients Visit us</h1>
					<br />
					...
					<div className="login_body_whyWe_cards">
						<OurAdvantage
							...
							para="Help others with what you Know and Earn ."
						/>
						<OurAdvantage
							title="Quick Payment"
							icon="mdi:cash-fast"
							para="Payments are really Quick and without hustle."
						/>
						<OurAdvantage
							title="Pay if Satisfied"
							icon="bxs:happy-alt"
							para="Only Pay if you have understood and satisfied with solution"
						/>
						<OurAdvantage
							title="Low Platform Fee"
							icon="mdi:cash-remove"
							para="Platform fee is as low as 5% only ."
						/>
					</div>
				</div>
			</div>
